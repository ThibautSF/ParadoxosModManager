...
public class BasicDialog {
	 ...
	 * @return
	 */
	public static Optional<ButtonType> showGenericConfirm(String title, String header, String message, List<ButtonType> buttons){
	 ...
	 * @return
	 */
	public static Optional<ButtonType> showGenericConfirm(String title, String header, String message, List<ButtonType> buttons, boolean cancel){
